...
const columns = [
    {field: 'equipment_model', headerName: 'Equipment Model', width: 150},
...
function ReliabilityMetricsDataGrid() {
    ...
    return (
        <Box>
            ...
            {!error && !loading && <DataGrid rows={metrics} columns={columns} getRowId={(row) => row.equipment_model} sx={{height: 400}}/>}
        </Box>
    );
}
